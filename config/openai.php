...
return [
    ...
    */
    ...
    | For AI analytics operations, we use a longer timeout to handle complex
    | analysis requests.
    */

    'request_timeout' => env('OPENAI_REQUEST_TIMEOUT', 90), // Increased to 90 seconds for AI analytics
    ...
    |--------------------------------------------------------------------------
    |
    | Specific timeout for analytics operations that may take longer due to
